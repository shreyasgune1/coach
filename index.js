...
// 2. WHATSAPP CLIENT (Hardened for Railway Nixpacks)
const client = new Client({
    authStrategy: new LocalAuth(),
    puppeteer: {
        headless: true,
        // CRITICAL: We leave executablePath completely out.
        // This forces Puppeteer to find the Chrome installed by Nixpacks.
        args: [
            '--no-sandbox',
...
client.on('message_create', async (msg) => {
    ...
    // Detection logic for Shreyas (Number and LID support)
